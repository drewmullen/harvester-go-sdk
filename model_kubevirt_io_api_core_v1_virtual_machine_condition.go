...
type _KubevirtIoApiCoreV1VirtualMachineCondition KubevirtIoApiCoreV1VirtualMachineCondition
...
func (o KubevirtIoApiCoreV1VirtualMachineCondition) MarshalJSON() ([]byte, error) {
...
func (o KubevirtIoApiCoreV1VirtualMachineCondition) ToMap() (map[string]interface{}, error) {
...
func (o *KubevirtIoApiCoreV1VirtualMachineCondition) UnmarshalJSON(data []byte) (err error) {
	...
	varKubevirtIoApiCoreV1VirtualMachineCondition := _KubevirtIoApiCoreV1VirtualMachineCondition{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKubevirtIoApiCoreV1VirtualMachineCondition)

	if err != nil {
		return err
	}

	*o = KubevirtIoApiCoreV1VirtualMachineCondition(varKubevirtIoApiCoreV1VirtualMachineCondition)

	return err
}

type NullableKubevirtIoApiCoreV1VirtualMachineCondition struct {
	value *KubevirtIoApiCoreV1VirtualMachineCondition
	isSet bool
}

func (v NullableKubevirtIoApiCoreV1VirtualMachineCondition) Get() *KubevirtIoApiCoreV1VirtualMachineCondition {
	return v.value
}

func (v *NullableKubevirtIoApiCoreV1VirtualMachineCondition) Set(val *KubevirtIoApiCoreV1VirtualMachineCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableKubevirtIoApiCoreV1VirtualMachineCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableKubevirtIoApiCoreV1VirtualMachineCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubevirtIoApiCoreV1VirtualMachineCondition(val *KubevirtIoApiCoreV1VirtualMachineCondition) *NullableKubevirtIoApiCoreV1VirtualMachineCondition {
	return &NullableKubevirtIoApiCoreV1VirtualMachineCondition{value: val, isSet: true}
}

func (v NullableKubevirtIoApiCoreV1VirtualMachineCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubevirtIoApiCoreV1VirtualMachineCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
