...
------------ | ------------- | ------------- | -------------
**AllowAutoConverge** | Pointer to **bool** |  | [optional] 
**AllowPostCopy** | Pointer to **bool** |  | [optional] 
**BandwidthPerMigration** | Pointer to **string** |  | [optional] 
**CompletionTimeoutPerGiB** | Pointer to **int64** |  | [optional] 
**DisableTLS** | Pointer to **bool** |  | [optional] 
**MatchSELinuxLevelOnMigration** | Pointer to **bool** |  | [optional] 
**Network** | Pointer to **string** |  | [optional] 
**NodeDrainTaintKey** | Pointer to **string** |  | [optional] 
**ParallelMigrationsPerCluster** | Pointer to **int64** |  | [optional] 
**ParallelOutboundMigrationsPerNode** | Pointer to **int64** |  | [optional] 
**ProgressTimeout** | Pointer to **int64** |  | [optional] 
**UnsafeMigrationOverride** | Pointer to **bool** |  | [optional] 
