...
func main() {
	...
	kubevirtIoApiCoreV1VirtualMachineInstanceMigration := *openapiclient.NewKubevirtIoApiCoreV1VirtualMachineInstanceMigration(*openapiclient.NewKubevirtIoApiCoreV1VirtualMachineInstanceMigrationSpec()) // KubevirtIoApiCoreV1VirtualMachineInstanceMigration | 
