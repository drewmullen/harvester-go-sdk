...
------------ | ------------- | ------------- | -------------
**CloudInitConfigDrive** | Pointer to [**KubevirtIoApiCoreV1CloudInitConfigDriveSource**](KubevirtIoApiCoreV1CloudInitConfigDriveSource.md) |  | [optional] 
**CloudInitNoCloud** | Pointer to [**KubevirtIoApiCoreV1CloudInitNoCloudSource**](KubevirtIoApiCoreV1CloudInitNoCloudSource.md) |  | [optional] 
**ConfigMap** | Pointer to [**KubevirtIoApiCoreV1ConfigMapVolumeSource**](KubevirtIoApiCoreV1ConfigMapVolumeSource.md) |  | [optional] 
**ContainerDisk** | Pointer to [**KubevirtIoApiCoreV1ContainerDiskSource**](KubevirtIoApiCoreV1ContainerDiskSource.md) |  | [optional] 
**DataVolume** | Pointer to [**KubevirtIoApiCoreV1DataVolumeSource**](KubevirtIoApiCoreV1DataVolumeSource.md) |  | [optional] 
**DownwardAPI** | Pointer to [**KubevirtIoApiCoreV1DownwardAPIVolumeSource**](KubevirtIoApiCoreV1DownwardAPIVolumeSource.md) |  | [optional] 
**DownwardMetrics** | Pointer to **map[string]interface{}** |  | [optional] 
**EmptyDisk** | Pointer to [**KubevirtIoApiCoreV1EmptyDiskSource**](KubevirtIoApiCoreV1EmptyDiskSource.md) |  | [optional] 
**Ephemeral** | Pointer to [**KubevirtIoApiCoreV1EphemeralVolumeSource**](KubevirtIoApiCoreV1EphemeralVolumeSource.md) |  | [optional] 
**HostDisk** | Pointer to [**KubevirtIoApiCoreV1HostDisk**](KubevirtIoApiCoreV1HostDisk.md) |  | [optional] 
**MemoryDump** | Pointer to [**KubevirtIoApiCoreV1MemoryDumpVolumeSource**](KubevirtIoApiCoreV1MemoryDumpVolumeSource.md) |  | [optional] 
...
**Secret** | Pointer to [**KubevirtIoApiCoreV1SecretVolumeSource**](KubevirtIoApiCoreV1SecretVolumeSource.md) |  | [optional] 
**ServiceAccount** | Pointer to [**KubevirtIoApiCoreV1ServiceAccountVolumeSource**](KubevirtIoApiCoreV1ServiceAccountVolumeSource.md) |  | [optional] 
**Sysprep** | Pointer to [**KubevirtIoApiCoreV1SysprepSource**](KubevirtIoApiCoreV1SysprepSource.md) |  | [optional] 
